...
class ItemSlotEightStation extends StatelessWidget {
  final void Function(MapLocation) onNavigationPressed;
  final void Function(MapLocation) onDetailPressed;
  final MapLocation data;

  ItemSlotEightStation(
      {this.onNavigationPressed, this.onDetailPressed, this.data});
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        child: SizedBox(
                            height: Dimens.oneTwentyFive,
                            width: Dimens.oneTwentyFive,
                            child: SvgPicture.asset(
                                'assets/images/slot8station.svg')),
                      ),
